/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: c1a41224c507788da844967611638009)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		R2_PREPROCESS_S3_ACCESS_KEY_ID: string;
		R2_PREPROCESS_S3_SECRET_ACCESS_KEY: string;
		photocards: R2Bucket;
		preprocessedPhotocards: R2Bucket;
		reports: R2Bucket;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "TURNSTILE_SECRET_KEY" | "R2_PREPROCESS_S3_ACCESS_KEY_ID" | "R2_PREPROCESS_S3_SECRET_ACCESS_KEY">> {}
}
