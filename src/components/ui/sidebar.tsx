...
function SidebarMenuAction({
    ...
    return (
        <Comp
            ...
            className={cn(
                "[&_svg]:text-foreground hover:[&_svg]:text-main-foreground text-main-foreground hover:bg-main outline-transparent absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-base p-0 transition-transform [&>svg]:size-4 [&>svg]:shrink-0",
                // Increases the hit area of the button on mobile.
                "after:absolute after:-inset-2 md:after:hidden",
...
function SidebarMenuSubButton({
    ...
    return (
        <Comp
            ...
            data-active={isActive}
            className={cn(
                "text-foreground hover:bg-main hover:outline-border hover:text-main-foreground  active:bg-main outline-transparent outline-2 [&>svg]:text-main-foreground flex min-h-7 min-w-0 -translate-x-px items-center gap-2 rounded-base px-2 py-1 focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0",
