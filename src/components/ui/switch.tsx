        ...
        <Label className="flex flex-row gap-2 items-center ">
            ...
            >
                <SwitchPrimitive.Thumb
                    ...
                    className={cn(
                        "pointer-events-none block h-4 w-4 rounded-full bg-main-darker border-2 border-border ring-0 transition-transform data-[state=checked]:translate-x-6 data-[state=unchecked]:translate-x-1",
                    )}
                />
            </SwitchPrimitive.Root>
            {text && <div>{text}</div>}
