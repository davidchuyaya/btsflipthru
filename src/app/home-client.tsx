...
function photocardToName(
    ...
    const collectionName =
        collections.find((col) => col.id === photocard.collection_id)?.name ??
        "Unknown Collection";
    const cardType =
        cardTypes.find((ct) => ct.id === photocard.card_type) ?? "Unknown Type";
    ...
    return (
        <div className="page gap-4">
            <div className="flex flex-row gap-8 items-stretch">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="bg-accent-light rounded-2xl pt-4 pb-4 pl-8 pr-8 text-left">
                        ...
                        <ul className="ul-spaced">
                            <li>
                                BTS announced their comeback set for March 20,
                                2026!
                            </li>
                            <li>
                                We launched fundamental pages of the site
                                (About, Contact, etc.).
                            </li>
                            <li>
                ...
                <BigProgressBar
                    progress={
                        homeStats.totalPhotocards === 0 ||
                        homeStats.totalPhotocardsWithoutImages === 0
                            ? 0
                            : Math.round(
                                  ((homeStats.totalPhotocards -
                                      homeStats.totalPhotocardsWithoutImages) /
                                      homeStats.totalPhotocards) *
                                      100,
                              )
                    }
